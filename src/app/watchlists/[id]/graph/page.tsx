      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold">Competitor Knowledge Graph</h1>
            <p className="text-sm text-[oklch(0.50_0_0)]">Your competitors as nodes. Gemini maps relationships between them.</p>
          </div>
