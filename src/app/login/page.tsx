    ...
    <div className="min-h-screen bg-[oklch(0.13_0_0)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[oklch(0.15_0_0)] border border-[oklch(0.22_0_0)] rounded-xl p-8">
          <h1 className="text-xl font-bold text-[oklch(0.95_0_0)] mb-1">Sign in to Tower</h1>
          <p className="text-sm text-[oklch(0.55_0_0)] mb-6">Competitive intelligence, automated.</p>
        ...
        <p className="text-center text-xs text-[oklch(0.45_0_0)] mt-4">
          ...
          <Link href="/signup" className="text-[oklch(0.72_0.16_240)] hover:text-[oklch(0.78_0.16_240)] transition-colors">
            Sign up
          </Link>
        </p>
      </div>
